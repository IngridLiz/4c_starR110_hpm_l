...
for n in range(num_step):
    ...
    if n in [0,4,8,12,16,20,24,28,32,36,40,44,48,52,56,60,64,68,72,76,80,120,160,100,800,1600,2400,3200,4000,6000,7999]:
        ...
        vtkfile_glc = File('results_4c_starR110_hpm_l/glc/glc_starR110_hpm_l_%sof8000.pvd' % n)
        vtkfile_atp = File('results_4c_starR110_hpm_l/atp/atp_starR110_hpm_l_%sof8000.pvd' % n)
        vtkfile_adp = File('results_4c_starR110_hpm_l/adp/adp_starR110_hpm_l_%sof8000.pvd' % n)
        vtkfile_gly = File('results_4c_starR110_hpm_l/gly/gly_starR110_hpm_l_%sof8000.pvd' % n)
        vtkfile_pyr = File('results_4c_starR110_hpm_l/pyr/pyr_starR110_hpm_l_%sof8000.pvd' % n)
        vtkfile_lac = File('results_4c_starR110_hpm_l/lac/lac_starR110_hpm_l_%sof8000.pvd' % n)
...
np.save('./output_4c_starR110_hpm_l', np.asarray(list_of_list))
